...
def setup
	@cheff = Cheff.create(chefname: "satya", email: "satya@example.com")
	@recipe = @cheff.recipes.build(name: "chicken parm", summary: "this is the best chicken parm recipe ever", 
